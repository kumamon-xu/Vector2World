...
public final class ApiExceptionHandler {
	...
	private static HttpStatus status(DatasetErrorCode code) {
		return switch (code) {
			case DATASET_NOT_FOUND, MODEL_PREVIEW_NOT_FOUND, GENERATION_JOB_NOT_FOUND -> HttpStatus.NOT_FOUND;
			...
			case DATASET_NOT_READY, GENERATION_JOB_NOT_READY -> HttpStatus.CONFLICT;
			case GENERATION_JOB_REJECTED -> HttpStatus.TOO_MANY_REQUESTS;
			case STORAGE_UNAVAILABLE, MODEL_PREVIEW_GENERATION_FAILED -> HttpStatus.INTERNAL_SERVER_ERROR;
